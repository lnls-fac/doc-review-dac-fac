...
%====================================================================
\section{Feedforward para perturbação em 60 Hz}

\begin{frame}
    \Huge{Feedforward para perturbação em 60 Hz}
\end{frame}
...
\begin{frame}{}
\centering
\Wider[4em]{\includegraphics[scale=0.29]{2024-05-10/figures/crosstalk_llrf_fofb.png}}
\end{frame}
...
\centering
    \includegraphics[scale=0.3]{2024-05-10/figures/bpm_data_rate_facq_sofbstate_on_fofbstate_on_gain_0p052_rfline_off_llrf_ki_8000_kp_155_vert_orb_at_01M2.png}
    \\
